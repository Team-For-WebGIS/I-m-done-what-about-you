...
namespace ShowTable
{
    public partial class FormTable : Form
    {
        ...
        IMapControl3 maxMapControl1;
        IToolbarMenu2 m_menuTableR = null;
        ...
        //构造函数
        public FormTable(AxMapControl pAxMapControl, IMapControl3 pMapCtrl)
        {
            InitializeComponent();
            axMapControl1 = pAxMapControl;
            maxMapControl1 = pMapCtrl;
        }
        ...
        {
            ILayer pLayer = (ILayer)maxMapControl1.CustomProperty;
        ...
        private void dataGridView1_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            pFeatSelection = pFLayer as IFeatureSelection;
            pFeatSelection.SelectFeatures(pQuery, esriSelectionResultEnum.esriSelectionResultNew, false);
            axMapControl1.ActiveView.Extent = feature.ShapeCopy.Envelope;
            axMapControl1.ActiveView.Refresh();
        }
